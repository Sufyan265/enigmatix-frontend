...
const AccountCard = ({ name, owner, category, path, companyId, handleDelete }) => {
    ...
    return (
        <div className="relative bg-white shadow-sm md:px-6 px-4 md:py-12 py-6 rounded-sm text-center border border-white hover:border-primary cursor-pointer transition-all group">
            <div className="absolute top-2 right-2 flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <button className="text-red-500 hover:text-red-700 py-[2px] px-[3px] rounded-sm"> <RiDeleteBin5Fill size={23} onClick={() => handleDelete(companyId)} /></button>
